...
function readFlags(flags) {
    return {      
        'protection': flags & maploader.TILESTATE_PROTECTIONZONE,
        'noPVP': flags & maploader.TILESTATE_NOPVP,
        'noLogout': flags & maploader.TILESTATE_NOLOGOUT,
        'PVPZone': flags & maploader.TILESTATE_PVPZONE,
        'refresh': flags & maploader.TILESTATE_REFRESH
    };
}
...
function loadFromOtb(fileName) {
    ...
    const Node = function(rawNode) {
        ...
        switch(rawNode.type) {
            case maploader.OTBM_MAP_HEADER: {
                this.type = maploader.OTBM_MAP_HEADER;
            ...
            case maploader.OTBM_MAP_DATA: {
                this.type = maploader.OTBM_MAP_DATA;
                i = this.readAttributes(stream, i);
                break;
            }

            case maploader.OTBM_TILE_AREA: {
                this.type = maploader.OTBM_TILE_AREA;
            ...
            case maploader.OTBM_TILE: {
                this.type = maploader.OTBM_TILE;
            ...
            case maploader.OTBM_ITEM: {
                this.type = maploader.OTBM_ITEM;
            ...
            case maploader.OTBM_HOUSETILE: {
                this.type = maploader.OTBM_HOUSETILE;
                this.x = stream.getUint8(i);
                i += 1;
                this.y = stream.getUint8(i);
                i += 1;
            ...
            case maploader.OTBM_WAYPOINTS: {
                this.type = maploader.OTBM_WAYPOINTS;
                break;
            }

            case maploader.OTBM_WAYPOINT: {
                this.type = maploader.OTBM_WAYPOINT;
            ...
            case maploader.OTBM_TOWNS: {
                this.type = maploader.OTBM_TOWNS;
                break;
            }

            case maploader.OTBM_TOWN: {
                this.type = maploader.OTBM_TOWN;
    ...
    Node.prototype.readAttributes = function(stream, i) {
        ...
        while (i<stream.byteLength) {
            ...
            switch(attrib) {
                ...
                case maploader.OTBM_ATTR_EXT_SPAWN_FILE: {
                ...
                case maploader.OTBM_ATTR_EXT_HOUSE_FILE: {
                ...
                case maploader.OTBM_ATTR_HOUSEDOORID: {
                    this.houseDoorId = stream.getUint8(i);
                    i += 1;
                    break;
                }

                case maploader.OTBM_ATTR_DESCRIPTION: {
                ...
                case maploader.OTBM_ATTR_DEPOT_ID: {
                    this.depotId = stream.getUint16(i, true);
                    i += 2;
                    break;
                }

                case maploader.OTBM_ATTR_TILE_FLAGS: {
                ...
                case maploader.OTBM_ATTR_RUNE_CHARGES: {
                    this.runeCharges = stream.getUint16(i, true);
                    i += 1;
                    break;
                }

                case maploader.OTBM_ATTR_COUNT: {
                    this.count = stream.getUint8(i);
                    i += 1;
                    break;
                }

                case maploader.OTBM_ATTR_CHARGES: {
                    this.count = stream.getUint16(i, true);
                    i += 2;
                    break;
                }

                case maploader.OTBM_ATTR_ITEM: {
                    this.tileid = stream.getUint16(i, true);
                    i += 2;
                    break;
                }

                case maploader.OTBM_ATTR_ACTION_ID: {
                    this.aid = stream.getUint16(i, true);
                    i += 2;
                    break;
                }

                case maploader.OTBM_ATTR_UNIQUE_ID: {
                ...
                case maploader.OTBM_ATTR_TELE_DEST: {
                    this.destination = {
                ...
                case maploader.OTBM_ATTR_WRITTENDATE: {
                    this.writtendate = stream.getUint32(i, true);
                    i += 4;
                    break;
                }

                case maploader.OTBM_ATTR_WRITTENBY: {
